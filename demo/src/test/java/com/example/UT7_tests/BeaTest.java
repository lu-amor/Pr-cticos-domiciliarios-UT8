...
public class BeaTest {
    ...
    public void testBea() {
        ...
        Collection<TVertice> bea = g.bea();
        assertTrue(bea.size() == 6);
        /*
        assertTrue(v1.getVisitado());
        assertTrue(v2.getVisitado());
        assertTrue(v3.getVisitado());
        assertTrue(v4.getVisitado());
        assertTrue(v5.getVisitado());
        assertTrue(v6.getVisitado());*/
    }
}
