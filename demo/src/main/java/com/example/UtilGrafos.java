        ...
        for (String verticeString : vertices) {
            if ((verticeString != null) && (!verticeString.trim().isEmpty())) {
                try {
                    ...
                    System.err.println("Error al procesar la línea de vértice: " + verticeString + " - " + e.getMessage());
                }
            }
        }
            ...
            if ((aristaString != null) && (!aristaString.trim().isEmpty())) {
                try {
                    ...
                    if (datos.length == 3) {
                        ...
                        System.err.println("Línea de arista inválida: " + aristaString);
                    }
                } catch (Exception e) {
                    System.err.println("Error al procesar la línea de arista: " + aristaString + " - " + e.getMessage());
                }
            }
        }
